	...
	<div class="container">
		...
		<div class="section">
			...
			<table border="1">
				...
				<tr>
					<td>${order_detail.it_id}</td>
					<td>상품명 :${order_detail.it_name} 상품사이즈:${order_detail.it_size} 색상:${order_detail.it_color}</td>
					<td>${order_detail.order_detail_count}</td>
					<td>2500만원</td>
					<td>${price}*0.05</td>
					<td>${price}*${order_detail.order_detail_count}</td>
				</tr>
			</table>
			...
			*받는분 <input type="text" name="ordername">
			<hr>

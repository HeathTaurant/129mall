...
회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지, 만14세 미만 아동의 개인정보 처리 시 법정대리인의 동의여부 확인 목적으로 개인정보를 처리합니다.
 ...
 <input type="radio" name="agree"/>동의합니다   
  <input type="radio" name="agree"/>동의안함 <hr>
...
회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지, 만14세 미만 아동의 개인정보 처리 시 법정대리인의 동의여부 확인 목적으로 개인정보를 처리합니다.
      ...
      <input type="radio" name="agree"/>동의합니다   
       <input type="radio" name="agree"/>동의안함  <hr><br><br>
   ...
   나머지 주소: <input type="text"  name="namujiAddress" size="50" /> <hr>
    ...
    <strong>할인정보</strong><hr>
     ...
     <input type="radio" name="paymethod">신용카드
     <input type="radio" name="paymethod">체크카드
     <input type="radio" name="paymethod">무통장입금
       <input type="radio" name="paymethod">실시간결제
     <input type="radio" name="paymethod">휴대폰결제 <hr>
     
          <strong>간편결제</strong><hr>
     <input type="radio" name="paymethod">카카오페이
     <input type="radio" name="paymethod">네이버페이
     <input type="radio" name="paymethod">스마일페이
     <input type="radio" name="paymethod">페이코(PAYCO) <hr>
